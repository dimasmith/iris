...
public class BankController {
    ...
    public BankController(SettlementService settlements) {
    ...
    static class AccountDto {
        ...
        static AccountDto fromAccount(BankAccount bankAccount) {
            return new AccountDto(
                    bankAccount.getId().getValue(),
                    bankAccount.getBalance(),
                    Currency.getInstance(bankAccount.getCurrency().getCurrencyCode())
            );
        }
